                                ...
                                <div class="menu-wrapper">
                                    <div class="menu-content">
                                        <ul class="mainmenu">
                                            ...
                                            <li><a class="active" href="/api/user/page">My Page</a></li>
                                        </ul> <!-- /.menu-list -->
                                    </div> <!-- /.hours-content-->
                                </div><!-- /.menu-wrapper -->
                            </nav>
                        ...
                        <aside class="widget bt-about-me-widget">
                            ...
                            <div class="widget-content">
                                <div class="author-thumb">
                                    ...
                                    <% if (user.getImage() != null) {
                                    %>
                                    <img src="/image/<%=user.getImage()%>" alt="img"
                                ...
                                <div class="info">
                                    <h3 class="designation"><%=user.getName()%>  <%=user.getSurname()%>
                                    </h3>
                                </div>
                            </div>
                        </aside>
                ...
                <div class="col-12">
                    <div class="contact-content-area">
                        ...
                        <div class="contact-form-area">
                            <form class="contact-form" action="/api/user/page" method="post"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-controller" id="surname" name="surname"
                                                           type="text" value="<%=user.getSurname()%>">
                                                    <span id="surnameErrorMessage"
                                                          class="error">This field is required.</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
