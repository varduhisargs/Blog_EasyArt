                        ...
                        <aside class="widget bt-about-me-widget">
                            ...
                            <div class="widget-content">
                                <div class="author-thumb">
                                    ...
                                    %>
                                    <img src="/image/<%=blog.getImage()%>" alt="img"
                                         style="object-fit: cover"/></a>

                                    <%
                                    } else {
                                    %>
                                    <img src="/assets/images/post/homeTwo/grid/post1.jpg" alt="img"
                                         style="object-fit: cover"/></a>
                                ...
                                <div class="info">
                                    <h3 class="designation"><%=blog.getTitle()%>
                                    </h3>
                                </div>
                            </div>
                        </aside>
                ...
                <div class="col-12">
                    <div class="contact-content-area">
                        ...
                        <div class="contact-form-area">
                            <form id="contact_form" class="contact-form" action="/api/user/blog/update" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description" name="description"
                                                              ...
                                                              rows="4"
                                                              cols="50"><%=blog.getDescription()%></textarea>
                                            ...
                                            <%
                                                for (Category category : allCategorise) {
                                                    if (blog.getCategoryList().contains(category)) {
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="categories" name="categoriesIds"
                                                           type="checkbox" value="<%=category.getId()%>" checked>
