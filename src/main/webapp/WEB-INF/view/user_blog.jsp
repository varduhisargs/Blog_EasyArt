                                ...
                                <div class="menu-wrapper">
                                    <div class="menu-content">
                                        <ul class="mainmenu">
                                            ...
                                            <li><a href="/api/register"
                                                   style="display: none">register</a>
                                            </li>
                                            <li><a class="active" href="/api/user/blog">My Blog</a></li>
                                ...
                                <article class="post hentry post-grid style-two">
                                    ...
                                    <div class="content-entry-wrap">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <br>
                                            <br>
                                            <form action="/api/user/blog/delete/delete" method="post">
                                            ...
                                            <br>
                                            <br>
                                            <form action="/api/user/blog/update" method="post">
                                                <input type="hidden" name="blogId" value="<%=blog.getId()%>">
                                                <button type="submit" class="btn btn-default btn-sm">
                                                    <span class="glyphicon glyphicon-log-out"></span>Update
                                                </button>
                                            </form>
